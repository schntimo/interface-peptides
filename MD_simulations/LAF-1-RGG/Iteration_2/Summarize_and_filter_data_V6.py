...
path_folders_interface = 'Y:/DATA/SIMULATION_FILES/LCD_Design_LAF1/Iteration_2/Simulation_files_interface/'
path_folders_homo = 'Y:/DATA/SIMULATION_FILES/LCD_Design_LAF1/Iteration_2/Simulation_files_homo/'
path_sequence_files = './It_2_laf1_sequences.txt'
filename_out = "results_LAF1_it2.csv"
...
for i in range(1,100+1):
    full_path = path_folders_interface + 'Iter_2_' + str(i) + '/'
    all_folders_int.append(full_path)

all_folders_homo = []
for i in range(1,100+1):
    full_path = path_folders_homo + 'Iter_2_' + str(i) + '/'
