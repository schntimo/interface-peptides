...
path_folders_interface = 'Y:/DATA/SIMULATION_FILES/LCD_Design_LAF1/Iteration_1/Simulation_files_interface/'
path_folders_homo = 'Y:/DATA/SIMULATION_FILES/LCD_Design_LAF1/Iteration_1/Simulation_files_homo/'
path_sequence_files = './It_1_laf1_sequences.txt'
filename_out = "results_LAF1_it1.csv"
...
for i in range(1,100+1):
    full_path = path_folders_interface + 'Iter_1_' + str(i) + '/'
    all_folders_int.append(full_path)

all_folders_homo = []
for i in range(1,100+1):
    full_path = path_folders_homo + 'Iter_1_' + str(i) + '/'
