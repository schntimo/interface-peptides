...
path_folders_interface = 'Y:/DATA/SIMULATION_FILES/LCD_Design/Run_NoDelim_V1/Iteration_7/Simulation_files_interface/'
path_folders_homo = 'Y:/DATA/SIMULATION_FILES/LCD_Design/Run_NoDelim_V1/Iteration_7/Simulation_files_homo/'
path_sequence_files = './It_7_nodelim_sequences.txt'
filename_out = "results_it_7.csv"
...
for i in range(1,25+1):
    full_path = path_folders_interface + 'Iter_7_' + str(i) + '/'
    all_folders_int.append(full_path)

all_folders_homo = []
for i in range(1,25+1):
    full_path = path_folders_homo + 'Iter_7_' + str(i) + '/'
