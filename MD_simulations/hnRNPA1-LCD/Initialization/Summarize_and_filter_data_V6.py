...
path_folders_interface = 'Y:/DATA/SIMULATION_FILES/LCD_Design/Run_NoDelim_V1/Initializaiton_V2/Simulation_files_interface/'
path_folders_homo = 'Y:/DATA/SIMULATION_FILES/LCD_Design/Run_NoDelim_V1/Initializaiton_V2/Simulation_files_homo/'
path_sequence_files = './initial_sequences_nodelim_V2.txt'
filename_out = "results_init_nodelim_V2.csv"
...
for i in range(1,300+1):
    full_path = path_folders_interface + 'Ini_' + str(i) + '/'
    all_folders_int.append(full_path)

all_folders_homo = []
for i in range(1,300+1):
    full_path = path_folders_homo + 'Ini_' + str(i) + '/'
    all_folders_homo.append(full_path)
    
    
std_limit_interface = 0.3 # in kcal/mol (FOR ENERGIES, LOG p reported)
