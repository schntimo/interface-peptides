...
path_folders_interface = 'C:/Users/schntimo/Documents/ETH/_Doktorat/ProjectFiles/LCD_Design/DDX4_Run_V1/Iteration_3_tempstore/Simulation_files_interface/'
path_folders_homo = 'C:/Users/schntimo/Documents/ETH/_Doktorat/ProjectFiles/LCD_Design/DDX4_Run_V1/Iteration_3_tempstore/Simulation_files_homo/'
path_sequence_files = './It_3_ddx4_sequences.txt'
filename_out = "results_DDX4_it3.csv"
...
for i in range(1,100+1):
    full_path = path_folders_interface + 'Iter_3_' + str(i) + '/'
    all_folders_int.append(full_path)

all_folders_homo = []
for i in range(1,100+1):
    full_path = path_folders_homo + 'Iter_3_' + str(i) + '/'
