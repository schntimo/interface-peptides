...
# Folder = './Slab_pep_sims/hnRNPA1/slab_1_pep_DeltaT/260K'
# name = 'hnRNPA1-LCD'

beads_hn = 168  
filename_out = 'contact_map_l1.png'
Folder = './Slab_pep_sims/LAF-1/slab_1_pep_DeltaT/260K'
name = 'LAF-1-RGG'

# beads_hn = 236    
# filename_out = 'contact_map_ddx4.png'
# Folder = './Slab_pep_sims/DDX4/slab_1_pep_DeltaT/260K'
# name = 'DDX4N'

# %% Other inputs

all_Filepath_raw = ['/seed1/all_bead_pepprot_colvar',
                    '/seed2/all_bead_pepprot_colvar',
                    '/seed3/all_bead_pepprot_colvar',
                    '/seed4/all_bead_pepprot_colvar',
                    '/seed5/all_bead_pepprot_colvar',
                    ]
...
Max_colorbar = np.percentile(bead_inter_DHH1C_CG_11_no4_wt_contactmap_norm, 99)
